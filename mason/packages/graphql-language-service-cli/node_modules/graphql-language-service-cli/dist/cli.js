...
switch (command) {
    case 'server':
        ...
        const options = {};
        if (argv === null || argv === void 0 ? void 0 : argv.port) {
            options.port = argv.port;
        }
        if (argv === null || argv === void 0 ? void 0 : argv.method) {
            options.method = argv.method;
        }
        if (argv === null || argv === void 0 ? void 0 : argv.configDir) {
            options.configDir = argv.configDir;
        }
        try {
            (0, graphql_language_service_server_1.startServer)(options);
        }
        catch (error) {
