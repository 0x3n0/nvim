...
function main(command, argv) {
    ...
    (0, assert_1.default)(argv.text || argv.file, 'A path to the GraphQL file or its contents is required.');
...
function _getAutocompleteSuggestions(queryText, point, schemaPath) {
    (0, assert_1.default)(schemaPath, 'A schema path is required to provide GraphQL autocompletion');
    try {
